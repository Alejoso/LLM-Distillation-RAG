...
class BgeM3Embeddings(Embeddings):
    ...
    def embed_documents(self, texts): # This function have to be named exaactly like this (embed_documents and embed_query) because langchain searches for this specific names
